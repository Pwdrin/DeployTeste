...
const cemeteryUnits = [
        ...
        {
          id: 'cacuia',
          name: 'Cemitério Cacuia',
          location: 'Cacuia, Rio de Janeiro',
          phone: '(21) 9999-3333',
          description: 'Nosso Cemitério de Cacuia oferece um ambiente tranquilo e acolhedor.',
          image: 'https://i.ibb.co/9kZRVC24/cacuia.webp',
        },
        {
          id: 'iraja',
          name: 'Cemitério Irajá',
          location: 'Irajá, Rio de Janeiro',
          phone: '(21) 9999-2222',
          description: 'Nosso Cemitério de Irajá está localizada em uma região de fácil acesso.',
          image: 'https://i.ibb.co/TxThStMZ/iraja.webp',
        },
        {
          id: 'guaratiba',
          name: 'Cemitério Guaratiba',
          location: 'Guaratiba, Rio de Janeiro',
          phone: '(21) 9999-1111',
          description: 'Nosso Cemitério de Guaratiba oferece um ambiente sereno e acolhedor.',
        ...
        },
        {
          ...
          phone: '(21) 9999-0000',
          description: 'Nosso Cemitério de Caju está situada em uma localização privilegiada.',
          image: 'https://i.ibb.co/ynkTybc7/caju.webp',
        },
        {
          id: 'inhauma',
          name: 'Cemitério Inhaúma',
          location: 'Inhaúma, Rio de Janeiro',
          phone: '(21) 9999-9999',
          description: 'Nosso Cemitério de Inhaúma oferece um ambiente tranquilo e acolhedor.',
        ...
        },
        {
          ...
          phone: '(21) 9999-8888',
          description: 'Nosso Cemitério Jardim da Saudade em Paciência oferece um ambiente sereno e acolhedor.',
        ...
        },
        {
          ...
          phone: '(21) 9999-7777',
          description: 'Nosso Cemitério Jardim da Saudade em Sulacap oferece um ambiente tranquilo e acolhedor.',
        ...
        },
        {
          ...
          phone: '(21) 9999-6666',
          description: 'Nosso Cemitério Memorial do Carmo oferece um ambiente sereno e acolhedor.',
        ...
        },
        {
          ...
          phone: '(21) 9999-5555',
          description: 'Nosso Cemitério Memorial do Rio oferece um ambiente tranquilo e acolhedor.',
        ...
        },
        {
          ...
          phone: '(21) 9999-4444',
          description: 'Nosso Cemitério Murundu Realengo oferece um ambiente sereno e acolhedor.',
          image: 'https://i.ibb.co/Z62PXKs0/murundu-realengo.webp',
        },
        {
          id: 'paqueta',
          name: 'Cemitério Paquetá',
          location: 'Paquetá, Rio de Janeiro',
          phone: '(21) 9999-3333',
          description: 'Nosso Cemitério de Paquetá oferece um ambiente tranquilo e acolhedor.',
        ...
        },
        {
          ...
          phone: '(21) 9999-2222',
          description: 'Nosso Cemitério de Piabas no Recreio oferece um ambiente sereno e acolhedor.',
        ...
        },
        {
          ...
          phone: '(21) 9999-1111',
          description: 'Nosso Cemitério de Ricardo de Albuquerque oferece um ambiente tranquilo e acolhedor.',
        ...
        },
        {
          ...
          phone: '(21) 9999-0000',
          description: 'Nosso Cemitério de Santa Cruz oferece um ambiente sereno e acolhedor.',
        ...
        },
        {
          ...
          phone: '(21) 9999-9999',
          description: 'Nosso Cemitério de São João Batista oferece um ambiente tranquilo e acolhedor.',
        ...
        },
        {
          ...
          location: 'Rio de Janeiro, RJ',
          phone: '(21) 9999-8888',
          description: 'Nosso Cemitério Israelita oferece um ambiente sereno e acolhedor.',
        ...
        },
        {
          ...
          phone: '(21) 9999-7777',
          description: 'Nosso Cemitério de Penitência oferece um ambiente tranquilo e acolhedor.',
          image: 'https://i.ibb.co/0jJMjfw1/penitencia.webp',
        },
        {
          ...
          phone: '(21) 9999-6666',
          description: 'Nosso Cemitério de São Francisco de Paula no Catumbi oferece um ambiente sereno e acolhedor.',
        ...
        },
        {
          ...
          location: 'Rio de Janeiro, RJ',
          phone: '(21) 9999-5555',
          description: 'Nosso Cemitério British Burial Fund oferece um ambiente tranquilo e acolhedor.',
